...
<tr><th>Mobile</th><td>
<input type="text" name="mobile" id="mobile" placeholder="Enter Mobile" class="form-control"></td></tr>
<tr><th>Aadhar</th><td>
<input type="text" name="aadhar" id="aadhar" placeholder="Enter Aadhar" class="form-control"></td></tr>
<tr><th>Address</th><td>
<textarea name="address" id="address" placeholder="Enter Address" class="form-control"></textarea></td></tr>
<tr><th>Photo</th><td>
...
if(isset($_POST['submit']))
{
  ...
  $sql="INSERT INTO `registration`(`name`, `email`, `mobile`, `aadhar`, `address`, `photo`, `password`) 
  VALUES ('$name','$email','$mobile','$aadhar','$address','$photo_name','$pswd')";
