...
<u><h1 class="text-center">Invoice</h1></u>
...
$sql="select booking.name,booking.mobile,booking.address,booking.gastype,booking.bookingdate,
...
<tr><th>Customer Name</th><td><?= $r['name']?></td><th>Mobile</th><td><?= $r['mobile']?></td></tr>
<tr><th>Address</th><td><?= $r['address']?></td><th>Status</th><td><?= $r['status']?></td></tr>
<tr><th colspan="2">Gas Type</th><th>Price</th><th>Subsidy</th></tr>
<tr style="height:50px"><td colspan="2"><?= $r['gastype']?></td><td>&#8377;<?= $_SESSION['price']?></td><td>&#8377;<?=$_SESSION['subsidy']?></td></tr>
