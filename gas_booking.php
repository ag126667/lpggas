...
<?php
$sql="select registration.name,registration.email,registration.mobile,registration.address,
...
<input type="text" name="mobile" value="<?= $r['mobile']?>" class="form-control" readonly>
</div>
<div class="form-group">
...
<textarea name="address" id="" cols="30" rows="2" class="form-control"><?= $r['address']?></textarea>
</div>
...
$sql="INSERT INTO `booking`(`regid`, `name`, `email`, `mobile`, `address`, `gastype`,`bookingdate`) 
VALUES ($id,'$name','$email','$mobile','$address','$gastype','$bookingdate')";
