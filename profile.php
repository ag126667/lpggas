...
<tr><th>Aadhar</th><td><?php echo $r['aadhar']?></td></tr>
  ...
  <div class="container">
    ...
    if($status=="approved")
    {
      echo "<span class='text-success'>Your Application for New Gas Connection is Valid And Approved .. Congratulations!
       Now You May Proceed For Booking</span>";
    }
...
<input type="text" name="mobile" id="mobile" value='<?php echo $r['mobile']?>' class="form-control">
</div>
<div class="form-group">
<label for="aadhar">Aadhar</label>
<input type="text" name="aadhar" id="aadhar" value='<?php echo $r['aadhar']?>' class="form-control" readonly>
</div>
<div class="form-group">
<label for="address">Address</label>
<textarea  name="address" id="address" class="form-control"><?php echo $r['address']?>
</textarea>
</div>
...
<div class="modal fade" id="feedback" >
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="edit">Feedback from Admin</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
