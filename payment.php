...
<tr><th>Customer Mobile</th><td><?= $_SESSION['mobile']?></td><th>Address</th><td><?= $_SESSION['address']?></td></tr>
...
<input type="radio" name="cardtype" value="debit" class="mx-4" checked>debit
</div>
